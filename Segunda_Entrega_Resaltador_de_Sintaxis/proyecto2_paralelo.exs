defmodule Highlighter do
  ...
  def process_directory(directory) do
    ...
    |> Enum.map(&Task.async(fn -> get_info(Path.join(directory, &1), css_file) end))
    |> Enum.each(&Task.await/1)
  end
end

# Ensure that the directory variable contains the path to the correct files directory
directory = "/Users/frix/Desktop/Carrera/S4/Implementación de métodos computacionales/repositorio/Implementaci-n_de_m-todos_computacionales/Segunda_Entrega_Resaltador_de_Sintaxis/files_paralelo"
